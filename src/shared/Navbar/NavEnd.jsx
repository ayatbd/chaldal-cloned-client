    ...
    <div className="flex flex-row gap-3 items-center justify-center h-full">
      <button className="flex items-center rounded-none px-2 h-full gap-2 cursor-pointer hover:bg-[#eeb529] transform delay-75">
        <svg
          ...
          data-reactid=".wn4b3blh2i.4.0.0.0.0.4.0.0.0"
        >
          <path
            id="Path_52"
            data-name="Path 52"
            ...
            fill="#ff6f71"
            data-reactid=".wn4b3blh2i.4.0.0.0.0.4.0.0.0.0"
          ></path>
          <path
            id="Path_53"
            data-name="Path 53"
            ...
            fill="#ff6f71"
            data-reactid=".wn4b3blh2i.4.0.0.0.0.4.0.0.0.1"
          ></path>
        </svg>
        ...
        <p
          className="ml-auto decoration-neutral text-[14px] font-[700]"
          data-reactid=".wn4b3blh2i.4.0.0.0.0.4.0.2"
        >
